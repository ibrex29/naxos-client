...
export default function ShipmentDetailsDialog({
  ...
  const exportShipmentData = (shipment: ShipmentDisplay) => {
    ...
    // Updated headers – includes Unit Cost To Be Sold
    const headers = [
      "Medicine",
      "Form",
      "Manufacturer",
    ...
    if (exportFormat === "pdf") {
      ...
      (doc as any).autoTable({
        ...
        columnStyles: { 8: { cellWidth: 28 } }, // make "Unit Cost To Be Sold" fit
      });
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-4">
                ...
                {/* Documents */}
                <div>
                  <h4 className="text-base font-semibold mb-4">Documents</h4>
                ...
                <div className="space-y-2 text-sm">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span>
                      ...
                      {selectedShipment.items
                        .reduce(
                          (s, i) => s + (i.quantity ?? 0) * (i.unitCostToBeSold ?? 0),
                          0
                        )
                        .toLocaleString()}
                    </span>
